#ifndef __optpfd__pfor__
#define __optpfd__pfor__
...
int csize[9] = {1, 2, 3, 4, 5, 7, 9, 14, 28};
int conum[9] = {28, 14, 9, 7, 5, 4, 3, 2, 1};

/*****************************************************************/
/* pack a bunch of fixed bit-length numbers into memory location */
/*****************************************************************/
...
unsigned int *pfor_decode(unsigned int *_p, unsigned int *_w, int flag)
{
    int i, s;
    unsigned int x;
    unsigned int b = cnum[((flag>>12) & 15)+2];
    unsigned int t = (flag>>10) & 3;
    unsigned start = flag & 1023;
    
    (unpack[((flag>>12) & 15)+2])(_p, _w);
    _w += ((b * BS)>>5);
